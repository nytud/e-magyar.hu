...
function createConstTree($modal, $sentence) {
    ...
    //check constituent string
    if (!checkBrackets(constituentString)) {
        console.log("Ill formatted constituent string.");
        return false;
    }
    ...
    //check Treant config
    try {
        config = getConfig(constituentString);
